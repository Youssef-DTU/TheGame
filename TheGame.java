...
public class TheGame {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("{Danish, English, Kurish & Turkish}");
        String language = "";
    ...
    public static String Output(String language, String text) {
        ...
        if (language.equalsIgnoreCase("english")) {
            if (text.equals("win")) {
                ...
                Output = "The game is a fun and competitive dice-rolling experience for two players. Each player takes turns rolling two dice, trying to accumulate points based on the sum of their rolls. Different sums correspond to unique game events that can either benefit or hinder the players. The first player to reach 3000 points wins the game. A player loses if their points fall below 0. You play by pressing enter.";
            ...
            if (text.equals("win")) {
                ...
                Output = "Spillet er en sjov og konkurrencepræget terningkastoplevelse for to spillere. Hver spiller skiftes til at kaste to terninger og forsøge at samle point baseret på summen af deres kast. Forskellige summer svarer til unikke spilbegivenheder, der enten kan gavne eller hæmme spillerne. Den første spiller, der når 3000 point, vinder spillet. En spiller taber, hvis deres point falder under 0. Du spiller ved at trykke på enter.";
            } else if (text.equals("Tower")) {
            ...
            } else if (text.equals("totalpoints")) {
...
class PlayerCreate {
    ...
    public PlayerCreate(String name, int Point) {
        this.Point = Point;
